      ...
      <div className={style.navBar}>
        ...
        <div className={style.menu}>
          ...
          <nav className={style.options}>
            <Link to="/perfil" className={style.option}>
              Edit Profile
            </Link>
            <div className={style.line}></div>
            <Link to="/booking" className={style.option}>
              My Bookings
            </Link>
            <div className={style.line}></div>
            <Link to="/favourites" className={style.option}>
              Favourites
            </Link>
            <div className={style.line}></div>
            <Link to="/travels" className={style.option}>
              History of travels
            </Link>
            <div className={style.line}></div>
            <Link to="/privacity" className={style.option}>
              Privacity
            </Link>
            <div className={style.line}></div>
            <button
